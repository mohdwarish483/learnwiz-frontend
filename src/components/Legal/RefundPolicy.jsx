    ...
    <Box p="32" className="backcolor" mt={'10vh'}>
      <VStack alignItems="flex-start" spacing="4">
        <Heading as="h1" fontSize="4xl" mb="4">
          Refund and Other Policy
        </Heading>
        <Text>
          Thanks for shopping at LearnUnit. We appreciate the fact that you like
        ...
        <Text>
          ...
          apply to transactions at LearnUnit. We’ll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at LearnUnit, you agree to the terms along with
          LearnUnit's Privacy Policy.
        </Text>
        ...
        <Text>
          All purchases are non-refundable but if you cancel your subscription
          within 7-days of purchase you will get your full refund through your
          registered payment mode. You can cancel your subscription at any time
          by logging into your account. Your cancellation will take effect at
          the end of the current paid term.
        </Text>
        <Text>
          If you are unsatisfied with our services, please email us at
          learnunitbusiness@gmail.com.
        </Text>
        <Text fontWeight="bold" mt="4" fontSize={'2xl'}>
          Your Suggestions
        </Text>
        <Text>
          ...
          (collectively, "Suggestions") provided by you to LearnUnit with
          respect to the website shall remain the sole and exclusive property of
          LearnUnit.
        </Text>
        <Text>
          LearnUnit shall be free to use, copy, modify, publish, or redistribute
        ...
        <Text>
          ...
          LearnUnit. We are not responsible for the content, accuracy or
        ...
        <Text>
          LearnUnit uses "Cookies" to identify the areas of our website that you
        ...
        <Text>
          LearnUnit is not responsible for any content, code or any other
          imprecision.
        </Text>
        <Text>LearnUnit does not provide warranties or guarantees.</Text>
        <Text>
          In no event shall LearnUnit be liable for any special, direct,
        ...
        <Text>
          The LearnUnit Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. LearnUnit is a distributor and not a
          publisher of the content supplied by third parties; as such, LearnUnit
          ...
          accessible via the LearnUnit Service. Without limiting the foregoing,
          LearnUnit specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the LearnUnit Service
          or on sites that may appear as links on the LearnUnit Service, or in
          the products provided as a part of, or otherwise in connection with,
          the LearnUnit Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          LearnUnit or any of its affiliates, employees, officers, directors,
          ...
          foregoing, LearnUnit does not warrant that the LearnUnit Service will
          be uninterrupted, uncorrupted, timely, or error-free.
        </Text>
        <Text mt="4" fontWeight={'bold'}>
          For more information about the RefundPolicy, please{' '}
